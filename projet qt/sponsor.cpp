...
Sponsor::Sponsor()
{
    ...
    bool Sponsor::recherche(int code)
    {
      ...
      /*  void Sponsor::save(QString nom, QString localisation, int numtel, int code, QString email)
        ...
        QString Sponsor::load()
        {     tmp="";
            QFile file("C:/Users/wildb/OneDrive/Desktop/projet qt/historique/historique.txt");
